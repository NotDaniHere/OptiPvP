...
@SuppressWarnings("NonAtomicOperationVolatileField")
        ...
        try {
            if (locationMap.containsKey(location)) {
                ...
                InputStream is = Minecraft.getMinecraft().getResourceManager()
                        .getResource(new ResourceLocation("optipvp/font/" + location)).getInputStream();
    ...
    public static void bootstrap() {
        new Thread(new Runnable() {
			...
			public void run() {
			    ...
			    normal_ = getFont(locationMap, "calibri.ttf", 19);
			    completed++;
			}
		}).start();
        new Thread(new Runnable() {
